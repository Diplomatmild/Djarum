...
class Talk:
  ...
  UA = "Line/8.0.0"
  LA = "DESKTOPWIN 11.2.5"
  

#"IOSIPAD\t7.18.0\tiPhone OS\t10.12.0"
  ...
  def qrLogin(self, callback):
    self.transport.path = self.auth_query_path
    qr = self.client.getAuthQrcode(True, "TEAM POTTERᴮᵒᵗ-PC")
    callback("Copy link weh dasaar kampret\n\nLogin LINK Qr TEAM POTTERᴮᵒᵗ : line://au/q/" + qr.verifier)
